...
namespace LiveSplit.Memory {
    public static class MemoryReader {
        ...
        public static Nullable<T> Read<T>(this Process targetProcess, IntPtr address, params int[] offsets) where T : struct {
            if (targetProcess == null || address == IntPtr.Zero) { return null; }
        ...
        public static string Read(this Process targetProcess, IntPtr address) {
            ...
            int length = Read<int>(targetProcess, address, 0x4).GetValueOrDefault(0);
        ...
        public static string Read(this Process targetProcess, IntPtr address, params int[] offsets) {
            ...
            int length = Read<int>(targetProcess, address + last, 0x4).GetValueOrDefault(0);
            if (length <= 0 || length > 2048) { return string.Empty; }
